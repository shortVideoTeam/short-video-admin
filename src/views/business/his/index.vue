<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="hisList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="搜索内容" align="center" prop="content"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="搜索时间" prop="createTime">
...
<script>
  import {listHis, getHis, delHis, addHis, updateHis, exportHis} from "@/api/business/his";
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除搜索历史记录编号为"' + ids + '"的数据项?', "警告", {
      ...
      handleExport() {
        ...
        this.$confirm('是否确认导出所有搜索历史记录数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {

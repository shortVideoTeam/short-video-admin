  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="状态，1-待付款 2-已付款" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择状态，1-待付款 2-已付款" clearable size="small">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态，1-待付款 2-已付款" align="center" prop="status"/>
      <el-table-column label="支付方式 1-微信 2-余额" align="center" prop="payWay"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="推荐页面，1-热门页" prop="page">
          <el-input v-model="form.page" placeholder="请输入推荐页面，1-热门页"/>
        </el-form-item>
        <el-form-item label="金额" prop="amount">
        ...
        <el-form-item label="支付方式 1-微信 2-余额" prop="payWay">
          <el-input v-model="form.payWay" placeholder="请输入支付方式 1-微信 2-余额"/>
        </el-form-item>
